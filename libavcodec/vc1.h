...
enum BlockType {
    ...
    BLOCK_INTER = 2,
    BLOCK_SKIPPED = 3,
    BLOCK_OOB = 1 << 2, // BLOCK_NONE | BLOCK_OOB
    BLOCK_INTRA_OOB = BLOCK_INTRA | BLOCK_OOB
};

/* Do not change order; optimzed for memcpy */
enum BlockIndex {
    MBIDX,
    BLOCKIDX_Y0,
    BLOCKIDX_T2,
...
enum PictureComponent {
    COMPONENT_TYPE_LUMA = 0,
    COMPONENT_TYPE_CHROMA = 1,
    COMPONENT_TYPE_MAX = 2,
    COMPONENT_LUMA = 0,
    COMPONENT_CB = 1,
    COMPONENT_CR = 2,
    COMPONENT_MAX = 3
...
/* Signal Level (Table 54)
 * as specified in 7.1.3.10
 */
enum SignalLevel {
    SIGNALLEVEL_BLOCK = 0 << 4,
    SIGNALLEVEL_MB = 1 << 4,
    SIGNALLEVEL_MASK = 1 << 4
};

/* Subblock Pattern (Table 54)
 * as specified in 7.1.3.10
 */
enum SubblockPattern {
    SUBBLOCK_SB0 = 1 << 3,
    SUBBLOCK_SB1 = 1 << 2,
    SUBBLOCK_SB2 = 1 << 1,
    SUBBLOCK_SB3 = 1,
    SUBBLOCK_BOTTOM = 1 << 1 | 1,
    SUBBLOCK_TOP = 1 << 3 | 1 << 2,
    SUBBLOCK_RIGHT = 1 << 2 | 1,
    SUBBLOCK_LEFT = 1 << 3 | 1 << 1,
    SUBBLOCK_BOTH = 15,
    SUBBLOCK_ALL = 15,
    SUBBLOCK_MASK = 15
};
...
struct VC1Context{
    ...
    VLC dc_diff_vlc[2][COMPONENT_TYPE_MAX];
